...
class SnapplesUserView: UIViewController, UITableViewDelegate, UITableViewDataSource {
    // resources
    ...
    let snapplesList = ["Blah", "Graham's Landing", "Parker", "Jankins", "Tig Ole Bitties", "Twerk What Yo Mama Gave Ya!", "item7", "item8", "Graham's Landing", "Parker", "Jankins", "Tig Ole Bitties", "Twerk What Yo Mama Gave Ya!", "item7", "item8"]
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let cellNib = UINib(nibName: "SnapplesUserCell", bundle: nil)
        snapplesTable.register(cellNib, forCellReuseIdentifier: "customSnappleCell")
        
        let lastLogin: NSDate = UserDefaults.standard.object(forKey: "lastLogin") as! NSDate
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell  {
        ...
        let cell: SnapplesUserCell = tableView.dequeueReusableCell(withIdentifier: "customSnappleCell", for: indexPath) as! SnapplesUserCell
        
        // border of the cell
        cell.backgroundContentView.layer.cornerRadius = 5
        cell.backgroundContentView.layer.borderWidth = 1
        cell.backgroundContentView.layer.borderColor = UIColor.darkGray.cgColor
...
class SnapplesUserCell: UITableViewCell {
